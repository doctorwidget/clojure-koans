...
(meditations
  ...
  (= (cons 1 (quote (2 3))) (list 1 2 3) (cons 1 [2 3])); 3 ways to make '(1 2 3)

  "The quote affects all of its arguments, not just the top level"
  (= (list 1 '(+ 2 3)) '(1 (+ 2 3))) ; quote impact is deeply nested

  "Syntax-quote (`) acts similarly to the normal quote"
  (= (list 1 2 3) `(1 2 3) '(1 2 3)) ; but more useful in macros because you can unsplice
